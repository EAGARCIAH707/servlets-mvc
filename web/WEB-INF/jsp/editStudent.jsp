        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <form role="form" name="EditStudent" action="EditStudent" method="post">
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <input type="text" name="id_number" id="id_number" class="form-control input-sm"
                                           placeholder="Identificacion" value="<%=session.getAttribute("id_number")%>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <input type="email" name="email" id="email" class="form-control input-sm"
                                   placeholder="Correo Electonico" value="<%=session.getAttribute("email")%>">
                        </div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <input type="password" name="password" id="password" class="form-control input-sm"
                                           placeholder="Contraseña" value="<%=session.getAttribute("password")%>">
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <input type="phone" name="phone" id="phone" class="form-control input-sm"
                                           placeholder="telefono" value="<%=session.getAttribute("phone")%>">
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <input type="username" name="username" id="username" class="form-control input-sm"
                                           placeholder="Nombre Usuario" value="<%=session.getAttribute("username")%>">
                                </div>
                            </div>
